...
I creaet a :code:`project` object in my tests, and :code:`pagure.lib.tasks_services.trigger_ci_build()` does 
...
That worked pretty well, writing the tests before the actual code feels weird at first but today that was a producitivy 
...
before, but I guess bad habbits came back and I never went all-in with it for a longer session. 
